...
* **hm:** use services.dropbox to resolve execution hangs ([3703bd0](https://github.com/ravn-ruby-path/hydenix-minimal/commit/3703bd04dc24e3850838f00118384fce4eed977a))
...
* update neovim configuration and adjust package inclusion logic ([e2000bf](https://github.com/ravn-ruby-path/hydenix-minimal/commit/e2000bfb9095b4fbe7e5b9b1b08ecf35c812b3c0))
...
* **editors:** add zed-editor as optional high-performance editor ([e3ade4c](https://github.com/ravn-ruby-path/hydenix/commit/e3ade4c4e6593559971b7073aa88626f8b76457f)), closes [hi#performance](https://github.com/hi/issues/performance)
...
* **editors:** add `zed` as optional high-performance editor via `hydenix.hm.editors.zed` option (default: false)
...
* Update filesystem UUIDs and clean up theme options in configuration ([82dc259](https://github.com/ravn-ruby-path/hydenix/commit/82dc259f5db74baaed49bac2a4fc723fd8b06877))
